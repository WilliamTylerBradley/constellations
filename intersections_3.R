...
## need to move by x, y, z, not lat long -------------------------------------------------------
# move along path of great circle
...
# ggplot(data = sky) +
#   geom_segment(data = lines, aes(x = long_1, y = lat_1, 
#                                        xend = long_2, yend = lat_2,
#                                        color = intersects)) +
#   geom_point(aes(x = star_long, y = star_lat)) +
#   geom_point(aes(x = constellation_long, y = constellation_lat),
#              shape = 4) 
# wrong projection

ggplot(data = sky) +
  geom_segment(data = lines, aes(x =  new_x_1, y = new_y_1, 
...
# looks good
# something is breaking with the shrinking code